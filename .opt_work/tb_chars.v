...
module tb_chars;
    ...
    initial begin
        ...
        $display("All mismatches occur at x in [%0d .. %0d]", minx, maxx);
        $display("Reachable paddle range is [7 .. 608] -> mismatch region is entirely outside it: %s",
                 (maxx < 7 || minx > 608) ? "YES" : "NO (overlap!)");
        $finish;
    end
endmodule
